...
tf.flags.DEFINE_string('train_dir','/tmp/train_dir','Where model ckpt are saved')
tf.flags.DEFINE_string('preds_dir','/tmp/PREDICTIONS','Where teachers predictions on test data are saved')
